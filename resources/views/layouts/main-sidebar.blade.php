<div class="container-fluid">
    <div class="row">
        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li class="{{ Str::contains(url()->current(), 'dashboard') ? 'active' : '' }}" >
                        <a href="{{ route('dashboard') }}">
                            <div class="pull-left"><i class="ti-home"></i><span
                                    class="right-nav-text">{{ __('sidebar.dashboard') }}</span>
                            </div>
                    ...
                    <!-- menu item Grades-->
                    <li class="{{ Str::contains(url()->current(), 'grades') ? 'active' : '' }}">
                        <a href="{{ route('grades.index') }}" {{-- data-toggle="collapse" data-target="#grades" --}}>
                            <div class="pull-left"><i class="ti-bar-chart"></i><span
                                    class="right-nav-text">{{ __('sidebar.grades') }}</span></div>
                            {{-- <div class="pull-right"><i class="ti-plus"></i></div> --}}
                            <div class="clearfix"></div>
                        </a>
                        {{-- <ul id="grades" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{ route('grades.index') }}">{{ __('sidebar.grades') }}</a></li>
                </ul> --}}
                </li>
                <!-- menu item calendar-->
                <li class="{{ Str::contains(url()->current(), 'classroom') ? 'active' : '' }}">
                    <a href="{{ route('classrooms.index') }}" {{-- href="javascript:void(0);"
                         data-toggle="collapse" data-target="#calendar-menu" --}}>
                        <div class="pull-left"><i class="ti-direction"></i><span
                                class="right-nav-text">{{ __('sidebar.classrooms') }}</span></div>
                        {{-- <div class="pull-right"><i class="ti-plus"></i></div> --}}
                        <div class="clearfix"></div>
                    </a>
        ...
        <div id="ascrail2000" class="nicescroll-rails nicescroll-rails-vr"
            style="width: 5px; z-index: 9; cursor: default; position: absolute; top: 0px; left: 225px; height: 216px; opacity: 0; display: block;">
            <div class="nicescroll-cursors"
                style="position: relative; top: 122px; float: right; width: 5px; height: 56px; background-color: rgba(0, 0, 0, 0.1); border: 0px; background-clip: padding-box; border-radius: 0px;">
            </div>
        </div>
        <!-- Left Sidebar End-->
